...
const healthAct = makeStatPathAct(
  ...
  [
    makeQuest('H1 — Body Scan',
      ...
      { taskTypes: ['LOG'] }, taskInputSpecific(3, 'scans'), 'xp-h1'),
    makeQuest('H2 — Hydration',
      ...
      { taskTypes: ['CHECK'] }, taskInputSpecific(6, 'completions'), 'xp-h2'),
    makeQuest('H3 — Meal Log',
      ...
      { taskTypes: ['LOG'] }, taskInputSpecific(12, 'entries'), 'xp-h3'),
    makeQuest('H4 — Daily Presence',
      ...
      { taskTypes: ['CHECK'] }, taskInputSpecific(24, 'logins'), 'xp-h4'),
  ],
);
...
const strengthAct = makeStatPathAct(
  ...
  [
    makeQuest('S1 — Sleep',
      ...
      { taskTypes: ['CIRCUIT'] }, taskInputSpecific(3, 'sessions'), 'xp-s1'),
    makeQuest('S2 — Walk Route',
      ...
      { taskTypes: ['LOCATION_TRAIL'] }, taskInputSpecific(6, 'routes'), 'xp-s2'),
    makeQuest('S3 — Workout Events',
      ...
      { taskTypes: ['CHECK'] }, taskInputSpecific(12, 'workouts'), 'xp-s3'),
    makeQuest('S4 — Workout Log',
      ...
      { taskTypes: ['COUNTER'] }, taskInputSpecific(24, 'entries'), 'xp-s4'),
  ],
);
...
const agilityAct = makeStatPathAct(
  ...
  [
    makeQuest('A1 — Chores',
      ...
      { taskTypes: ['CHECK'] }, taskInputSpecific(3, 'chores'), 'xp-a1'),
    makeQuest('A2 — Clear Inbox',
      ...
      { taskTypes: ['CHECKLIST'] }, taskInputSpecific(6, 'clears'), 'xp-a2'),
    makeQuest('A3 — Event Completions',
      ...
      { taskTypes: ['CHECK'] }, taskInputSpecific(12, 'events'), 'xp-a3'),
    makeQuest('A4 — Quick Actions',
      ...
      { taskTypes: ['CHECK'] }, taskInputSpecific(24, 'completions'), 'xp-a4'),
  ],
);
...
const defenseAct = makeStatPathAct(
  ...
  [
    makeQuest('DF1 — Schedule',
      ...
      { taskTypes: ['CHECK'] }, taskInputSpecific(3, 'events created'), 'xp-df1'),
    makeQuest('DF2 — Clear the Deck',
      ...
      { taskTypes: ['CHECK'] }, taskInputSpecific(6, 'days'), 'xp-df2'),
    makeQuest('DF3 — Log Transactions',
      ...
      { taskTypes: ['LOG'] }, taskInputSpecific(12, 'transactions'), 'xp-df3'),
    makeQuest('DF4 — Inventory',
      ...
      { taskTypes: ['COUNTER'] }, taskInputSpecific(24, 'items'), 'xp-df4'),
  ],
);
...
const charismaAct = makeStatPathAct(
  ...
  [
    makeQuest('C1 — Self Compliment',
      ...
      { taskTypes: ['LOG'] }, taskInputSpecific(3, 'entries'), 'xp-c1'),
    makeQuest('C2 — Gratitude',
      ...
      { taskTypes: ['LOG'] }, taskInputSpecific(6, 'entries'), 'xp-c2'),
    makeQuest('C3 — Acts of Kindness',
      ...
      { taskTypes: ['LOG'] }, taskInputSpecific(12, 'entries'), 'xp-c3'),
    makeQuest('C4 — Shared Activity',
      ...
      { taskTypes: ['CHECK'] }, taskInputSpecific(24, 'activities'), 'xp-c4'),
  ],
);
...
const wisdomAct = makeStatPathAct(
  ...
  [
    makeQuest('W1 — Meditation',
      ...
      { taskTypes: ['TIMER'] }, taskInputSpecific(3, 'sessions'), 'xp-w1'),
    makeQuest('W2 — Mood Log',
      ...
      { taskTypes: ['RATING'] }, taskInputSpecific(6, 'entries'), 'xp-w2'),
    makeQuest('W3 — Form Tasks',
      ...
      { taskTypes: ['FORM'] }, taskInputSpecific(12, 'completions'), 'xp-w3'),
    makeQuest('W4 — Wisdom Habits',
      ...
      { taskTypes: ['CHECK', 'TIMER', 'FORM', 'RATING', 'LOG', 'TEXT'] }, taskInputSpecific(24, 'completions'), 'xp-w4'),
  ],
);
