        ...
        if (meta.insuranceExpiry) {
          ...
          if (d >= 0) {
            vehicleEvents.push({
              ...
              date: meta.insuranceExpiry.slice(0, 10),
              daysAway: d,
            });
          }
        }
        ...
        if (meta.serviceNextDate) {
          ...
          if (d >= 0) {
            vehicleEvents.push({
              ...
              date: meta.serviceNextDate.slice(0, 10),
              daysAway: d,
            });
          }
        }
        ...
        if (meta.expiryDate) {
          ...
          if (d >= 0) {
            docEvents.push({
              ...
              date: meta.expiryDate.slice(0, 10),
              daysAway: d,
            });
          }
        }
