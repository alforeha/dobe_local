...
export function GoalSection({
  ...
  return (
    <section className="space-y-3 rounded-2xl border border-gray-200 bg-white/90 p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800/80">
